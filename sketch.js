...
function preload(){
  ...
  jump = loadImage("assets/jaguar1.png");
  dead = loadImage("assets/jaguar4.png");
...
function draw(){
  ...
  if(gamestate === play){
    ...
    text("press S to continue",100,600)
    bg.velocityX = 0;
    player.velocityY = 0;
    player.y = 780;
    ...
    if(mousePressedOver(close)){
      ...
      player.addAnimation("killed", dead)
